...
def createInstance(poisson=False, variance = 0.0):
    ...
    instance = LRPinstance(coord,demandList,customers,facilities, totalVehicleCap, fOpeningCost, fCapacity, numParticles, variance=variance,poisson=poisson)
